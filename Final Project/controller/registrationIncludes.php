...
// define variables and set to empty values
    $nameErr = $emailErr = $degreeErr = $genderErr = $userErr = $passErr = $confrmPassErr =$cityErr= $vehicleErr = $dobErr = "";
    $name = $email= $city = $vehicle = $gender = $username = $password = $cnfrmPass = "";
    $dob = $successmsg = "";
    $dobdd = $dobmm = $dobyy = "";
    $errCount = 0;
    $message = '';
  ...
  if (empty($_POST['vehicle'])) {
    $vehicleErr = "Must select a Vehicle";  
  } else {
    $vehicle = ($_POST["vehicle"]);
        ...
        if ($errCount > 0) {
            ...
            if (registerUser($data)) {
                ...
                $name = '';
                $email = '';
                $username = $city = $vehicle = $gender = $dob = '';
            }
